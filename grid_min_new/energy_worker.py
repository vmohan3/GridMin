...
def task_listener_calculate_energy(gearman_worker, gearman_job):
	...
	st = "update gm2_values_to_run set energy = {0} where angle0 = {1} and angle1 = {2} and angle2 = {3} and angle3 = {4}".format(asd[2],angles[1],angles[2],angles[3],angles[4])
	execute_query(conn2,st)

	st = "update gm2_values_to_run set done = {0} where angle0 = {1} and angle1 = {2} and angle2 = {3} and angle3 = {4}".format(1,angles[1],angles[2],angles[3],angles[4])
...
st = "insert into gm2_worker values ({0},'calculate_energy')".format(gearman_pid)
